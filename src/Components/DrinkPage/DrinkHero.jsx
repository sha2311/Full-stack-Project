...
import BgDrink from "../../../public/bgdrink.png";



const DrinkHero = () => {
  return (
    <section className='bg-no-repeat bg-top overflow-hidden h-[441px] md:h-[555px] w-full' style={{backgroundImage:  `url(${BgDrink})`}}>
